...
class SettingsController extends Controller
{
    ...
    public function site_setting_store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'site_meta_keyword' => 'required',
            'site_meta_url' => 'required',
        ...
        foreach ($request->all() as $key => $value) {
            ...
            if (($key == 'site_logo' || $key == 'site_favicon_logo')) {
                ...
                if (setting($key) != null && file_exists(public_path('images/logo/' . setting($key))))
                ...
                file_put_contents($directory . '/' . $value, $image_base64);
            }
