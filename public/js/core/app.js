/******/ (() => { // webpackBootstrap
    ...
    (function (window, document, $) {
        ...
        var currMode = localStorage.getItem(dataLayout + '-current-skin');
        var setMode = currMode == 'dark-layout' ? currMode : 'light-layout';
        setLayout(setMode);
        ...
        function setLayout(currentLocalStorageLayout) {
            ...
            if (switchToLayout === 'dark-layout') {
                ...
                $html.attr('data-layout','dark-layout');
                ...
                $html.attr('data-layout','bordered-layout');
                ...
                $html.attr('data-layout','semi-dark-layout');
            } else {
                ...
                $html.attr('data-layout','light-layout');
            }
