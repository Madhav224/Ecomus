...
(function (window, document, $) {
  ...
  var bubbleEditor = new Quill('.quill-editor', {
    bounds: '.quill-editor',
    modules: {
      formula: true,
      syntax: true
  ...
  var snowEditor = new Quill('.snow-quill-editor', {
    bounds: '.snow-quill-editor',
    modules: {
      formula: true,
      syntax: true,
      toolbar: '.snow-quill-editor'
    },
    theme: 'snow'
  });
  ...
  var fullEditor = new Quill('.full-quill-editor', {
