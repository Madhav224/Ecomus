            ...
            <div class="container">
                <div class="tf-accordion-wrap d-flex justify-content-between">
                    <div class="content">
                        ...
                        <div class="flat-accordion style-default has-btns-arrow mb_60">
                            <div class="flat-toggle active">
                                <div class="toggle-title active">Pellentesque habitant morbi tristique senectus et
                                    netus?</div>
                    ...
                    <div class="box tf-other-content radius-10 bg_grey-8">
                        ...
                        <p class="text_black-2 mb_40">If you have an issue or question that requires immediate
                        ...
                        <div class="d-flex gap-20 align-items-center">
                            <a href="{{route('contact')}}"
                                class="tf-btn radius-3 btn-fill animate-hover-btn justify-content-center">Contact us</a>
                            <a href="{{route('contact')}}" class="tf-btn btn-line">Live chat<i
