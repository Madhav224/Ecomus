 ...
 <!-- Slider -->
        <section class="tf-slideshow about-us-page position-relative">
            <div class="banner-wrapper">
                <img class="lazyload" src="{{asset('frontend/images/slider/about-banner-01.jpg')}}"
                    data-src="{{asset('frontend/images/slider/about-banner-01.jpg')}}" alt="image-collection">
                <div class="box-content text-center">
                    <h1 class="title " style="color: #ffffff; border:1px solid black;">About Us</h1>
                    <div class="container">
            ...
            <div class="container">
                <div class="tf-grid-layout md-col-2 tf-img-with-text style-4">
                    <div class="tf-image-wrap">
                        <img class="lazyload w-100" data-src="{{asset('frontend/images/collections/collection-69.jpg')}}"
                            src="{{asset('frontend/images/collections/collection-69.jpg')}}" alt="collection-img">
                    </div>
                ...
                <div class="tf-grid-layout md-col-2 tf-img-with-text style-4">
                    ...
                    <div class="grid-img-group">
                        <div class="tf-image-wrap box-img item-1">
                            <div class="img-style">
                                <img class="lazyload" src="{{asset('frontend/images/collections/collection-71.jpg')}}"
                                    data-src="{{asset('frontendimages/collections/collection-71.jpg')}}" alt="img-slider">
                            </div>
                        </div>
                        <div class="tf-image-wrap box-img item-2">
                            <div class="img-style">
                                <img class="lazyload" src="{{asset('frontend/images/collections/collection-70.jpg')}}"
                                    data-src="{{asset('frontend/images/collections/collection-70.jpg')}}" alt="img-slider">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="testimonial-item lg lg-2">
                                        ...
                                        <div class="icon">
                                            <img class="lazyload" data-src="{{asset('frontend/images/item/quote.svg')}}" alt=""
                                                src="{{asset('frontendimages/item/quote.svg')}}">
                                        </div>
                                        <div class="rating">
                                            <i class="icon-star"></i>
                                            <i class="icon-star"></i>
                                        ...
                                        <div class="author box-author">
                                            <div class="box-img d-md-none rounded-0">
                                                <img class="lazyload img-product" data-src="{{asset('frontend/images/item/tets3.jpg')}}"
                                                    src="{{asset('frontend/images/item/tets3.jpg')}}" alt="image-product">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item lg lg-2">
                                        ...
                                        <div class="icon">
                                            <img class="lazyload" data-src="{{asset('frontend/images/item/quote.svg')}}" alt=""
                                                src="{{asset('frontend/images/item/quote.svg')}}">
                                        </div>
                                        <div class="rating">
                                            <i class="icon-star"></i>
                                            <i class="icon-star"></i>
                                        ...
                                        <div class="author box-author">
                                            <div class="box-img d-md-none rounded-0">
                                                <img class="lazyload img-product" data-src="{{asset('frontend/images/item/tets4.jpg')}}"
                                                    src="{{asset('frontend/images/item/tets4.jpg')}}" alt="image-product">
                                            </div>
                                            <div class="content">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="gallery-item hover-img">
                                    <div class="img-style">
                                        <img class="lazyload img-hover" data-src="{{asset('frontend/images/shop/gallery/gallery-7.jpg')}}"
                                            src="{{asset('frontend/images/shop/gallery/gallery-7.jpg')}}" alt="image-gallery">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-item hover-img">
                                    <div class="img-style">
                                        <img class="lazyload img-hover" data-src="{{asset('frontend/images/shop/gallery/gallery-3.jpg')}}"
                                            src="{{asset('frontend/images/shop/gallery/gallery-3.jpg')}}" alt="image-gallery">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-item hover-img">
                                    <div class="img-style">
                                        <img class="lazyload img-hover" data-src="{{asset('frontend/images/shop/gallery/gallery-5.jpg')}}"
                                            src="{{asset('frontend/images/shop/gallery/gallery-5.jpg')}}" alt="image-gallery">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-item hover-img">
                                    <div class="img-style">
                                        <img class="lazyload img-hover" data-src="{{asset('frontend/images/shop/gallery/gallery-8.jpg')}}"
                                            src="{{asset('frontend/images/shop/gallery/gallery-8.jpg')}}" alt="image-gallery">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-item hover-img">
                                    <div class="img-style">
                                        <img class="lazyload img-hover" data-src="{{asset('frontend/images/shop/gallery/gallery-6.jpg')}}"
                                            src="{{asset('frontend/images/shop/gallery/gallery-6.jpg')}}" alt="image-gallery">
                                    </div>
                                </div>
                            </div>
                        </div>
