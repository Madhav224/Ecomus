    ...
    <div class="container">
        <div class="tf-grid-layout lg-col-2 tf-login-wrap">
            ...
            <div class="tf-login-form">
                    ...
                    {{-- Guest: Show Login + Reset Password --}}
                    <div id="recover">
                    ...
                    <div id="login">
                        ...
                        <div>
                            <form method="POST" action="{{ route('frontend.login') }}">
                                @csrf
                                <div class="tf-field style-1 mb_15">
                                    <input class="tf-field-input tf-input" type="email" name="email" required>
                                    <label class="tf-field-label fw-4 text_black-2">Email *</label>
                                </div>
                                <div class="tf-field style-1 mb_30">
                                    <input class="tf-field-input tf-input" type="password" name="password" required>
            ...
            @guest
                <div class="tf-login-content">
                    ...
                    <p class="mb_20">Sign up for early Sale access plus tailored new arrivals, trends and promotions. 
                        To opt out, click unsubscribe in our emails.</p>
                    <a href="{{ route('frontend.register') }}" class="tf-btn btn-line">
