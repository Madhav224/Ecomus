      ...
      <div class="card-body py-2 my-25">
        ...
        <div class="row mt-2 pt-50">
          ...
          <div class="col-12 col-sm-3 mb-1">
            ...
            <div class="col-12 col-sm-6 mb-1">
                <label class="form-label" for="site_meta_title">Site Meta Title</label>
                <input
                  type="text"
                  class="form-control"
                  id="site_meta_title"
                  ...
                  value="{{setting('site_meta_title')}}"
                  data-msg="Please enter Site Meta Title"
                />
              </div>
              <div class="col-12 col-sm-6 mb-1">
                <label class="form-label" for="site_meta_url">Site Meta URL</label>
                <input
                  type="text"
                  class="form-control"
                  id="site_meta_url"
                  name="site_meta_url"
                  placeholder="Site Meta URL"
                  value="{{setting('site_meta_url')}}"
                  data-msg="Please enter Site Meta URL"
                />
              </div>
              <div class="col-12 col-sm-6 mb-1">
                <label class="form-label" for="site_meta_keyword">Site Meta Keyword</label>
                <textarea
                  class="form-control"
                  id="site_meta_keyword"
                  name="site_meta_keyword"
                  placeholder="Site Meta Keyword"
                  data-msg="Please enter Site Meta Keyword"
                >{{setting('site_meta_keyword')}}</textarea>
              </div>
              <div class="col-12 col-sm-6 mb-1">
                <label class="form-label" for="site_meta_description">Site Meta Description</label>
                <textarea
                  class="form-control"
                  id="site_meta_description"
                  name="site_meta_description"
                  placeholder="Site Meta Description"
                  value="{{setting('site_meta_description')}}"
                  data-msg="Please enter Site Meta Description"
                >{{setting('site_meta_description')}}</textarea>
              </div>
          </div>
