...
@php
    ...
    $siteModalAnimation = setting('site_modal_action') ?? 'fade';
@endphp
{{-- <html class="loading {{ $configData['theme'] === 'light' ? '' : $configData['layoutTheme'] }}"
  ...
  @if ($configData['theme'] === 'dark') d      ata-layout="dark-layout" @endif> --}}



<html class="loaded light-layout @if ($configData['theme'] === 'dark') dark-layout @endif"
