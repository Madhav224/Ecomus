                            ...
                            <div class="tf-product-info-wrap position-relative">
                                ...
                                <div class="tf-product-info-list other-image-zoom">
                                    ...
                                    <div class="tf-product-info">
                                         ...
                                         <span class="product-short-description fw-5 fs-16">
                                    ...
                                    <div class="tf-product-info-liveview">
                                       <p class="fw-6">
                                        <span class="text-danger">Many</span> people are viewing this right now
                                        </p>
                                       ...
                                       @if($variant_color)
                                            <div class="variant-picker-item">
                                                <div class="variant-picker-label">
                                                    Color: <span class="fw-6 variant-picker-label-value value-currentColor">Select</span>
                                                </div>
                                            ...
                                            @endphp
                                               <div class="color-batch">
                                                    ...
                                                    <input type="radio" class="d-none" 
                                                        ...
                                                        name="color" 
                                                        value="{{ $color->id }}" 
                                                        wire:model="filter.variant_colors">

                                                    <!-- Color circle with tooltip -->
                                                    <label for="color-{{ $color->id }}" 
                                                        class="color-pill-label @if($filter['variant_colors'] == [$color->id]) active @endif"  style="background-color: {{ trim($bgColor) }};">
                                                        
                                                        <span class="tooltip" style="background-color: {{ trim($bgColor) }};" title="{{ ucfirst(strtolower($color->variant_name)) }}"></span>
                                                    </label>
                                                </div>
                                        ...
                                        @if($variant_size)
                                            <div class="variant-picker-item">
                                                <div class="variant-picker-label">
                                                    Size: <span class="fw-6 variant-picker-label-value">Select</span>
                                                </div>
                                                <div class="variant-picker-values">
                                                    {{-- @foreach($variant_size as $size)
                                                        <input type="radio" name="size1" id="size-{{ $size->id }}">
                                                        <label class="style-text size-btn" for="size-{{ $size->id }}">
                                                            <p>{{ $size->variant_name }}</p>
                                                        </label>
                                                    @endforeach --}}
                                                    @foreach($variant_size as $size)
                                                        <div class="size-batch" >
                                                            <input type="radio" class="d-none" 
                                                                id="size-{{ $size->id }}" 
                                                                name="size" 
                                                                value="{{ $size->id }}" 
                                                                wire:model="filter.variant_sizes">

                                                            <label for="size-{{ $size->id }}" 
                                                                @class([
                                                                    'size-pill',
                                                                    'active' => in_array($size->id, $filter['variant_sizes'] ?? [])
                                                                ])>
                                                                {{ strtoupper($size->variant_name) }}
                                                            </label>
                                                        </div>
                                                    @endforeach
                                    ...
                                    <div class="tf-product-info-extra-link">
                                        <a href="{{route('contact')}}"  class="tf-product-extra-icon">
                                            <div class="icon">
                        ...
                        <div class="widget-tabs style-has-border">
                            ...
                            <div class="widget-content-tab">
                                <div class="widget-content-inner active">
                                    <div class="">
                                        <p class="mb_30">
                                             {{ strip_tags($product->product_long_description) }}
                                        </p>
                                        <div class="tf-product-des-demo">
                                            <div class="right">
                                                ...
                                                <h3 class="fs-16 fw-5">Materials Information</h3>
                                                <ul class="mb-0">
                                                    @foreach($product->product_additional_details as $title => $value)
                                                        <li>
                                        ...
                                        <tbody>
                                            <tr class="tf-attr-pa-color">
                                                ...
                                                <td class="tf-attr-value">
                                                    <p>
                                                         @foreach($variant_color as $index => $color)
        {{ ucfirst(strtolower($color->variant_name)) }}@if(!$loop->last), @endif
    @endforeach
                                                    </p>
                                                </td>
                                            </tr>
